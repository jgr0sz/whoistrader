...
In a nutshell, it takes multiple APIs from CS2 marketplaces, reversal DBs, and Steam itself (TBA) and aggregates them into one fat API response that represents the "profile" of a user. 

This project itself is not meant to qualify users as trustworthy or not; it instead provides information for potential buyers/sellers to access to make a decision.
